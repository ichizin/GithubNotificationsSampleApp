 ...
 * @author ichizin
 */
public class GetIssueHttpUrl extends UseCase {

    private final NotificationApiRepository notificationApiRepository;
    private String apiUrl;

    public GetIssueHttpUrl(ThreadExecutor threadExecutor,
    ...
    protected Observable buildUseCaseObservable() {
        return this.notificationApiRepository.getIssueHttpUrl(this.apiUrl);
    }
}
