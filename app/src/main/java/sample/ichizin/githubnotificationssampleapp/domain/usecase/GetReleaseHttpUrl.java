package sample.ichizin.githubnotificationssampleapp.domain.usecase;
 ...
 * @author ichizin
 */
public class GetReleaseHttpUrl extends UseCase {

    private final NotificationApiRepository notificationApiRepository;
    private String apiUrl;

    public GetReleaseHttpUrl(ThreadExecutor threadExecutor,
    ...
    protected Observable buildUseCaseObservable() {
        return this.notificationApiRepository.getReleaseUrl(this.apiUrl);
    }
}
